...
3. Clone this repo to your local environment and deploy the functionapp code. Ensure the prerequisites have been met as above, alternatively deploy the function using [VSCode](https://docs.microsoft.com/en-us/azure/azure-functions/functions-develop-vs-code?tabs=csharp).
